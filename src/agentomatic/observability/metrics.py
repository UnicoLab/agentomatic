...
# Counters
REQUEST_COUNT = _counter("agentomatic_requests_total", "Total requests", ["method", "endpoint", "status_code"])
AGENT_INVOCATION_COUNT = _counter("agentomatic_agent_invocations_total", "Agent invocations", ["agent_name", "status"])
ERROR_COUNT = _counter("agentomatic_errors_total", "Errors", ["error_type", "agent_name"])

# Histograms
REQUEST_DURATION = _histogram("agentomatic_request_duration_seconds", "Request duration", ["method", "endpoint"])
AGENT_DURATION = _histogram("agentomatic_agent_duration_seconds", "Agent duration", ["agent_name"])
LLM_DURATION = _histogram("agentomatic_llm_duration_seconds", "LLM call duration", ["provider", "model"])
