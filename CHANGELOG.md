...
> from Conventional Commits, so it will collapse into a single `v1.3.0` entry
> driven by the release commit. This hand-organized version is kept coherent for
> readers, and `docs/changelog.md` retains the full, categorized detail.
