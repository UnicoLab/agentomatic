...
Custom schemas are also automatically serialized into the agent's **A2A Agent Card** at `GET /api/v1/{agent_name}/card` (and the universal `.well-known/agent.json` directory).
